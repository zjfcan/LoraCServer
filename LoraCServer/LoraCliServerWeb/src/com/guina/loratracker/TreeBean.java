...
import com.guina.loratracker.model.CD;
import com.guina.loratracker.model.Company;
import com.guina.loratracker.model.Country;
...
public class TreeBean implements Serializable
{
	...
	public void init()
	{
		for (CDXmlDescriptor current : cdXmlDescriptors)
		{
			...
			CD cd = new CD(current.getTitle(), current.getArtist(), company, current.getPrice(),
							current.getYear());
